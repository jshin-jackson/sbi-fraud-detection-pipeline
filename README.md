...
```bash
# Beeline 실행 예시
beeline -u "jdbc:hive2://ccycloud-1.jshin.root.comops.site:10000/;\
  principal=hive/_HOST@ROOT.COMOPS.SITE;\
  ssl=true;\
  sslTrustStore=/var/lib/cloudera-scm-agent/agent-cert/cm-auto-global_truststore.jks;\
  trustStorePassword=zpXWTjeWPjvNDU4mQnDQPQKn50xfVI9HYX12DSc05x3" \
